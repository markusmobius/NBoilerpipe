...
namespace BoilerPipe
{
	...
	public sealed class IgnoreBlocksAfterContentFromEndFilter : HeuristicFilterBase, BoilerpipeFilter
	{
		public static readonly IgnoreBlocksAfterContentFromEndFilter
			 INSTANCE = new IgnoreBlocksAfterContentFromEndFilter
			();
