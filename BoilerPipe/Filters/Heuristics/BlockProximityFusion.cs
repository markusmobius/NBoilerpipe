...
namespace BoilerPipe
{
	...
	public sealed class BlockProximityFusion : BoilerpipeFilter
	{
		...
		public static readonly BlockProximityFusion MAX_DISTANCE_1 = new BlockProximityFusion(1, false, false);

		public static readonly BlockProximityFusion MAX_DISTANCE_1_SAME_TAGLEVEL = new BlockProximityFusion(1, false, true);

		public static readonly BlockProximityFusion MAX_DISTANCE_1_CONTENT_ONLY = new BlockProximityFusion(1, true, false);

		public static readonly BlockProximityFusion MAX_DISTANCE_1_CONTENT_ONLY_SAME_TAGLEVEL = new BlockProximityFusion(1, true, true);
