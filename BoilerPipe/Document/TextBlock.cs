...
namespace BoilerPipe
{
	...
	public class TextBlock 
	{
		...
		public static readonly TextBlock EMPTY_START = new TextBlock(string.Empty, EMPTY_BITSET, 0, 0, 0, 0, -1);

		public static readonly TextBlock EMPTY_END = new TextBlock(string.Empty, EMPTY_BITSET, 0, 0, 0, 0, int.MaxValue);
		...
		public virtual void MergeNext (TextBlock other)
		{
